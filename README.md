...
A: Maybe. This gives zero advantage over others so I would not classify it as cheats
...
### Q: Linux support/build?
 A: While I don't have a native version, it seems to work flawlessly with wine. If I can find a way to build for various Linux distros aswell I might do that eventually. Also yes I am aware that Siege doesn't even run online in Linux yet, but I'm sure it will soon enough.
